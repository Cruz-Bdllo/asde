...
//
//     document.getElementById("signatures").style.display = (state==="ESTRUCTURAL") ? "block" : "none";
// });
//
...
// let fechas = document.querySelector('input[type="date"]');
// console.log(fechas);
// fechas.addEventListener("change", () => {
//     console.log(fechas.value);
//     fechas.value = dateFormat(fechas.value, 'YYYY/MM/DD');
//    console.log(fechas.value);
// });